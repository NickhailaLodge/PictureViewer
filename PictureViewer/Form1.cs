...
namespace PictureViewer
{
    public partial class Form1 : Form
    {
        ...
        private void btnSet_Click(object sender, EventArgs e)
        {
            ...
            //If the user clicks ok, change the picturebox control's background to the color the user chose.
        ...
        private void chkStretch_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //sizemode property to "Stretch". 
            //If the user clears the checkbox, it changes to "Normal"
